    ...
    <x-slot name="admin">
                    ...
                    <div class="cs_slider_wrapper">
                        <div class="slick_slide_in">
                            <div class="cs_hero cs_style_2 position-relative">
                                ...
                                <div class="cs_hero_right">
                                    <div class="cs_hero_thumb"><img src="admin/assets/img/hero2.jpg" alt="Thumb"></div>
                                    <div class="cs_animated_text position-absolute">
                                        <img src="admin/assets/img/animated_text.png" alt="Text Image">
                        ...
                        <div class="slick_slide_in">
                            <div class="cs_hero cs_style_2 position-relative">
                                ...
                                <div class="cs_hero_right">
                                    <div class="cs_hero_thumb"><img src="admin/assets/img/hero5.jpg" alt="Thumb"></div>
                                    <div class="cs_animated_text position-absolute">
                                        <img src="admin/assets/img/animated_text.png" alt="Text Image">
                                        <span class="cs_text_light cs_accent_bg"></span>
                                    </div>
                        ...
                        <div class="slick_slide_in">
                            <div class="cs_hero cs_style_2 position-relative">
                                ...
                                <div class="cs_hero_right">
                                    <div class="cs_hero_thumb"><img src="admin/assets/img/hero6.jpg" alt="Thumb"></div>
                                    <div class="cs_animated_text position-absolute">
                                        <img src="admin/assets/img/animated_text.png" alt="Text Image">
                                        <span class="cs_text_light cs_accent_bg"></span>
                                    </div>
                ...
                <div class="cs_slider_container" data-autoplay="0" data-loop="1" data-speed="600" data-center="0" data-slides-per-view="responsive" data-xs-slides="1" data-sm-slides="2" data-md-slides="2" data-lg-slides="3" data-add-slides="4">
                    <div class="cs_slider_wrapper">
                        <div class="slick_slide_in">
                            <div class="cs_product cs_style_1 cs_bordered">
                                <div class="cs_product_thumb position-relative">
                                    <img src="admin/assets/img/product4.png" alt="Product Image" class="w-100">
                        ...
                        <div class="slick_slide_in">
                            <div class="cs_product cs_style_1 cs_bordered">
                                <div class="cs_product_thumb position-relative">
                                    <img src="admin/assets/img/product5.png" alt="Product Image" class="w-100">
                                    <div class="cs_cart_badge position-absolute">
                                        <a href="wishlist.html" class="cs_cart_icon cs_accent_bg cs_white_color">
                                            <i class="fa-regular fa-heart"></i>
                                        </a>
                        ...
                        <div class="slick_slide_in">
                            <div class="cs_product cs_style_1 cs_bordered">
                                <div class="cs_product_thumb position-relative">
                                    <img src="admin/assets/img/product6.png" alt="Product Image" class="w-100">
                                    <div class="cs_cart_badge position-absolute">
                                        <a href="wishlist.html" class="cs_cart_icon cs_accent_bg cs_white_color">
                                            <i class="fa-regular fa-heart"></i>
                                        </a>
                        ...
                        <div class="slick_slide_in">
                            <div class="cs_product cs_style_1 cs_bordered">
                                <div class="cs_product_thumb position-relative">
                                    <img src="admin/assets/img/product7.png" alt="Product Image" class="w-100">
                                    <div class="cs_cart_badge position-absolute">
                                        <a href="wishlist.html" class="cs_cart_icon cs_accent_bg cs_white_color">
                                            <i class="fa-regular fa-heart"></i>
                                        </a>
                        ...
                        <div class="slick_slide_in">
                            <div class="cs_product cs_style_1 cs_bordered">
                                <div class="cs_product_thumb position-relative">
                                    <img src="admin/assets/img/product16.png" alt="Product Image" class="w-100">
                                    <div class="cs_cart_badge position-absolute">
                                        <a href="wishlist.html" class="cs_cart_icon cs_accent_bg cs_white_color">
                                            <i class="fa-regular fa-heart"></i>
                                        </a>
        ...
        <div class="row cs_gap_y_24">
            <div class="col-sm-6">
                <div class="cs_category cs_style_1">
                    <a href="shop.html" class="cs_category_thumb position-relative">
                        <img src="admin/assets/img/men2.jpg" alt="Category Image" class="w-100">
            ...
            <div class="col-sm-6">
                <div class="cs_category cs_style_1">
                    <a href="shop.html" class="cs_category_thumb position-relative">
                        <img src="admin/assets/img/women2.jpg" alt="Category Image" class="w-100">
                        <span class="cs_category_btn">
                            <span>Women</span>
                            <span><i class="fa-solid fa-arrow-right"></i></span>
                        </span>
            ...
            <div class="col-sm-6">
                <div class="cs_category cs_style_1">
                    <a href="shop.html" class="cs_category_thumb position-relative">
                        <img src="admin/assets/img/kid1.jpg" alt="Category Image" class="w-100">
                        <span class="cs_category_btn">
                            <span>Kids</span>
                            <span><i class="fa-solid fa-arrow-right"></i></span>
                        </span>
            ...
            <div class="col-sm-6">
                <div class="cs_category cs_style_1">
                    <a href="shop.html" class="cs_category_thumb position-relative">
                        <img src="admin/assets/img/children2.jpg" alt="Category Image" class="w-100">
                        <span class="cs_category_btn">
                            <span>Children</span>
                            <span><i class="fa-solid fa-arrow-right"></i></span>
                        </span>
            ...
            <div class="container-fluid">
                <div class="cs_isotope cs_style_1 cs_isotope_col_4 cs_has_gutter_24">
                    ...
                    <div class="cs_isotope_item t_shirt shoes">
                        <div class="cs_product cs_style_1 cs_bordered">
                            <div class="cs_product_thumb position-relative">
                                <img src="admin/assets/img/product1.png" alt="Product Image" class="w-100">
                    ...
                    <div class="cs_isotope_item t_shirt leggings">
                        <div class="cs_product cs_style_1 cs_bordered">
                            <div class="cs_product_thumb position-relative">
                                <img src="admin/assets/img/product2.png" alt="Product Image" class="w-100">
                    ...
                    <div class="cs_isotope_item t_shirt accessories skirt">
                        <div class="cs_product cs_style_1 cs_bordered">
                            <div class="cs_product_thumb position-relative">
                                <img src="admin/assets/img/product3.png" alt="Product Image" class="w-100">
                    ...
                    <div class="cs_isotope_item accessories c_shirt shoes jeans">
                        <div class="cs_product cs_style_1 cs_bordered">
                            <div class="cs_product_thumb position-relative">
                                <img src="admin/assets/img/product8.png" alt="Product Image" class="w-100">
                                <div class="cs_cart_badge position-absolute">
                                    <a href="wishlist.html" class="cs_cart_icon cs_accent_bg cs_white_color">
                                        <i class="fa-regular fa-heart"></i>
                                    </a>
                    ...
                    <div class="cs_isotope_item c_shirt leggings jeans">
                        <div class="cs_product cs_style_1 cs_bordered">
                            <div class="cs_product_thumb position-relative">
                                <img src="admin/assets/img/product9.png" alt="Product Image" class="w-100">
                                <div class="cs_discount_badge cs_white_bg cs_fs_14 cs_primary_color position-absolute">-8%</div>
                                <div class="cs_cart_badge position-absolute">
                                    <a href="wishlist.html" class="cs_cart_icon cs_accent_bg cs_white_color">
                                        <i class="fa-regular fa-heart"></i>
                    ...
                    <div class="cs_isotope_item skirt leggings c_shirt">
                        <div class="cs_product cs_style_1 cs_bordered">
                            <div class="cs_product_thumb position-relative">
                                <img src="admin/assets/img/product10.png" alt="Product Image" class="w-100">
                                <div class="cs_cart_badge position-absolute">
                                    <a href="wishlist.html" class="cs_cart_icon cs_accent_bg cs_white_color">
                                        <i class="fa-regular fa-heart"></i>
                                    </a>
                    ...
                    <div class="cs_isotope_item c_shirt shoes accessories jeans">
                        <div class="cs_product cs_style_1 cs_bordered">
                            <div class="cs_product_thumb position-relative">
                                <img src="admin/assets/img/product11.png" alt="Product Image" class="w-100">
                                <div class="cs_discount_badge cs_white_bg cs_fs_14 cs_primary_color position-absolute">-12%</div>
                                <div class="cs_cart_badge position-absolute">
                                    <a href="wishlist.html" class="cs_cart_icon cs_accent_bg cs_white_color">
                                        <i class="fa-regular fa-heart"></i>
                    ...
                    <div class="row">
                        <div class="col-lg-6">
                            <div class="cs_card_thumb">
                                <img src="admin/assets/img/card3.jpg" alt="Card Image">
                            </div>
                        </div>
            ...
            <div class="container">
                <div class="cs_section_heading cs_style_1">
                    <div class="cs_section_heading_in">
                        <h2 class="cs_section_title cs_fs_50 cs_bold mb-0">
                            Read our exclusive fashion <br> trendy articles</h2>
                    </div>
                    <div class="cs_hesction_heading_right">
                        <a href="blog.html" class="cs_btn cs_style_1 cs_fs_16 cs_medium">See All Blogs</a>
                    </div>
                </div>
                ...
                <div class="row cs_gap_y_30">
                    <div class="col-lg-4">
                        <div class="cs_post cs_style_1">
                            <a href="blog_details.html" class="cs_post_thumb cs_zoom">
                                <img src="admin/assets/img/post1.jpg" alt="Post Image" class="cs_zoom_in w-100">
                            </a>
                            ...
                            <div class="cs_post_info">
                                <h3 class="cs_post_title cs_fs_28 cs_semibold">
                                    <a href="blog_details.html">Mastering the art of wardrobe manage essentials</a>
                                </h3>
                                <p class="cs_post_subtitle">Discover the key to simplifying your style with a capsule wardrobe. Learn how to curate a collection of versatile pieces that will elevate your fashion game...</p>
                    ...
                    <div class="col-lg-4">
                        <div class="cs_post cs_style_1">
                            <a href="blog_details.html" class="cs_post_thumb cs_zoom">
                                <img src="admin/assets/img/post2.jpg" alt="Post Image" class="cs_zoom_in w-100">
                            </a>
                            <div class="cs_post_meta">
                    ...
                    <div class="col-lg-4">
                        <div class="cs_post cs_style_1">
                            <a href="blog_details.html" class="cs_post_thumb cs_zoom">
                                <img src="admin/assets/img/post3.jpg" alt="Post Image" class="cs_zoom_in w-100">
                            </a>
                            <div class="cs_post_meta">
                                <p class="cs_post_meta_info mb-0 cs_fs_14">JANUARY 13, 2023</p>
                            </div>
