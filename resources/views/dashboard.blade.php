                    ...
                    <div class="row">
                        <div class="col-sm-12">
                            <div class="page-title-box">
                                <div class="float-end">
                                    <ol class="breadcrumb">
                                        <li class="breadcrumb-item"><a href="dashboard/#">Metrica</a>
                                        </li><!--end nav-item-->
                            ...
                            <div class="card">
                                <div class="card-header">
                                    <div class="row align-items-center">
                                        ...
                                        <div class="col-auto">
                                            <div class="dropdown">
                                                <a href="dashboard/#" class="btn btn-sm btn-outline-light dropdown-toggle" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                                    This Year<i class="las la-angle-down ms-1"></i>
                                                </a>
                                                <div class="dropdown-menu dropdown-menu-end">
                                                    <a class="dropdown-item" href="dashboard/#">Today</a>
                                                    <a class="dropdown-item" href="dashboard/#">Last Week</a>
                                                    <a class="dropdown-item" href="dashboard/#">Last Month</a>
                                                    <a class="dropdown-item" href="dashboard/#">This Year</a>
                                                </div>
                                            </div>
                                        </div><!--end col-->
                                    </div> <!--end row-->
                            ...
                            <div class="card">
                                <div class="card-header">
                                    <div class="row align-items-center">
                                        ...
                                        <div class="col-auto">
                                            <div class="dropdown">
                                                <a href="dashboard/#" class="btn btn-sm btn-outline-light dropdown-toggle" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                                    All<i class="las la-angle-down ms-1"></i>
                                                </a>
                                                <div class="dropdown-menu dropdown-menu-end">
                                                    <a class="dropdown-item" href="dashboard/#">Purchases</a>
                                                    <a class="dropdown-item" href="dashboard/#">Emails</a>
                                                </div>
                                            </div>
                                        </div><!--end col-->
                                    </div> <!--end row-->
                                    ...
                                    <div class="row align-items-center">
                                        ...
                                        <div class="col-auto">
                                            <div class="dropdown">
                                                ...
                                                <div class="dropdown-menu dropdown-menu-end">
                                                    <a class="dropdown-item" href="dashboard/#">Today</a>
                                                    <a class="dropdown-item" href="dashboard/#">Yesterday</a>
                                                    <a class="dropdown-item" href="dashboard/#">Last Week</a>
                                                </div>
                                            </div>
                                        </div><!--end col-->
                                ...
                                <div class="card-body">
                                    <ul class="list-group custom-list-group">
                                        <li class="list-group-item align-items-center d-flex justify-content-between">
                                            <div class="media">
                                                <img src="dashboard/assets/images/small/rgb.svg" height="30" class="me-3 align-self-center rounded" alt="...">
                                            ...
                                            <div class="align-self-center">
                                                <a href="dashboard/#" class="btn btn-sm btn-soft-primary">4.3k <i class="las la-external-link-alt font-15"></i></a>
                                            </div>
                                        </li>
                                        <li class="list-group-item align-items-center d-flex justify-content-between">
                                            <div class="media">
                                                <img src="dashboard/assets/images/small/cobweb.svg" height="30" class="me-3 align-self-center rounded" alt="...">
                                                <div class="media-body align-self-center">
                                            ...
                                            <div class="align-self-center">
                                                <a href="dashboard/#" class="btn btn-sm btn-soft-primary">3.7k <i class="las la-external-link-alt font-15"></i></a>
                                            </div>
                                        </li>
                                        <li class="list-group-item align-items-center d-flex justify-content-between">
                                            <div class="media">
                                                <img src="dashboard/assets/images/small/blocks.svg" height="30" class="me-3 align-self-center rounded" alt="...">
                                                <div class="media-body align-self-center">
                                            ...
                                            <div class="align-self-center">
                                                <a href="dashboard/#" class="btn btn-sm btn-soft-primary">2.9k <i class="las la-external-link-alt font-15"></i></a>
                                            </div>
                                        </li>
                                        <li class="list-group-item align-items-center d-flex justify-content-between">
                                            <div class="media">
                                                <img src="dashboard/assets/images/small/atom.svg" height="30" class="me-3 align-self-center rounded" alt="...">
                                                <div class="media-body align-self-center">
                                            ...
                                            <div class="align-self-center">
                                                <a href="dashboard/#" class="btn btn-sm btn-soft-primary">1.6k <i class="las la-external-link-alt font-15"></i></a>
                                            </div>
                                        </li>
                                    </ul>
                                </div><!--end card-body-->
                                    ...
                                    <div class="d-flex">
                                        ...
                                        <div class="d-block ms-2 align-self-center">
                                            ...
                                            <p class="mb-0 text-muted">It is a long established fact that a reader will
                                                ...
                                                <a href="dashboard/#" class="text-primary">Read More <i class="las la-arrow-right"></i></a>
                                            </p>
                                        </div>
                                    </div>
                                </div><!--end card-body-->
                                ...
                                <div class="card-bodyp-0">
                                    <div class="p-3" data-simplebar style="height: 400px;">
                                        <div class="activity">
                                                ...
                                                <div class="activity-info-text">
                                                    <div class="d-flex justify-content-between align-items-center">
                                                        <p class="text-muted mb-0 font-13 w-75"><span>Donald</span>
                                                            updated the status of <a href="dashboard/#">Refund #1234</a> to awaiting customer response
                                                        </p>
                                                ...
                                                <div class="activity-info-text">
                                                    <div class="d-flex justify-content-between align-items-center">
                                                        <p class="text-muted mb-0 font-13 w-75"><span>Lucy Peterson</span>
                                                            was added to the group, group name is <a href="dashboard/#">Overtake</a>
                                                        </p>
                                            ...
                                            <div class="activity-info">
                                                <div class="icon-info-activity">
                                                    <img src="dashboard/assets/images/users/user-5.jpg" alt="" class="rounded-circle thumb-sm">
                                                </div>
                                                <div class="activity-info-text">
                                                    <div class="d-flex justify-content-between align-items-center">
                                                        <p class="text-muted mb-0 font-13 w-75"><span>Joseph Rust</span>
                                                            opened new showcase <a href="dashboard/#">Mannat #112233</a> with theme market
                                                        </p>
                                            ...
                                            <div class="activity-info">
                                                <div class="icon-info-activity">
                                                    <img src="dashboard/assets/images/users/user-4.jpg" alt="" class="rounded-circle thumb-sm">
                                                </div>
                                                <div class="activity-info-text">
                                                    <div class="d-flex justify-content-between align-items-center">
                                                        <p class="text-muted mb-0 font-13 w-75"><span>Joseph Rust</span>
                                    ...
                                    <div class="table-responsive browser_users">
                                        <table class="table mb-0">
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    <td><a href="dashboard/#" class="text-primary">Referal</a></td>
                                ...
                                <div class="card-body">
                                    <div class="table-responsive browser_users">
                                        <table class="table mb-0">
                                            ...
                                            <tbody>
                                                <tr>
                                                    <td><img src="dashboard/assets/images/logos/chrome.png" alt="" height="16" class="me-2">Chrome</td>
                                                    <td>10853<small class="text-muted">(52%)</small></td>
                                                    <td> 52.80%</td>
                                                    <td>566<small class="text-muted">(92%)</small></td>
                                                </tr><!--end tr-->
                                                <tr>
                                                    <td><img src="dashboard/assets/images/logos/micro-edge.png" alt="" height="16" class="me-2">Microsoft Edge</td>
                                                    <td>2545<small class="text-muted">(47%)</small></td>
                                                    <td> 47.54%</td>
                                                    <td>498<small class="text-muted">(81%)</small></td>
                                                </tr><!--end tr-->
                                                <tr>
                                                    <td><img src="dashboard/assets/images/logos/in-explorer.png" alt="" height="16" class="me-2">Internet-Explorer</td>
                                                    <td>1836<small class="text-muted">(38%)</small></td>
                                                    <td> 41.12%</td>
                                                    <td>455<small class="text-muted">(74%)</small></td>
                                                </tr><!--end tr-->
                                                <tr>
                                                    <td><img src="dashboard/assets/images/logos/opera.png" alt="" height="16" class="me-2">Opera</td>
                                                    <td>1958<small class="text-muted">(31%)</small></td>
                                                    <td> 36.82%</td>
                                                    <td>361<small class="text-muted">(61%)</small></td>
                                                </tr><!--end tr-->
