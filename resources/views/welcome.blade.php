<x-guest-layout>
    <x-slot name="admin">
                    ...
                    <div class="slick_slide_in">
                        <div class="cs_hero cs_style_1">
                            <div class="cs_hero_text">
                                <h1 class="cs_heto_title cs_fs_67 cs_bold">
                                    Winter Collection For Women
                                </h1>
                                <p class="cs_heto_subtitle">
                                    we are more than just an online shopping destination; we're
                                    your personal gateway to a world of fashion, trendsetting
                                    styles, and unparalleled convenience. We believe that fashion
                                    is a reflection of your individuality, and our mission is to
                                    make every shopping experience with us.
                                </p>
                                <a href="shop.html" class="cs_btn cs_style_1 cs_fs_16 cs_medium">Shop Now</a>
                            </div>
                            <div class="cs_hero_thumb cs_bg_filed" data-src="admin/assets/img/hero1.jpg"></div>
                        </div>
                    </div>
                    <div class="slick_slide_in">
                        <div class="cs_hero cs_style_1">
                            ...
                            <div class="cs_hero_thumb cs_bg_filed" data-src="admin/assets/img/hero3.jpg"></div>
                        </div>
                    </div>
                    <div class="slick_slide_in">
                        <div class="cs_hero cs_style_1">
                            ...
                            <div class="cs_hero_thumb cs_bg_filed" data-src="admin/assets/img/hero4.jpg"></div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="col-xl-3 col-sm-6">
                        <div class="cs_iconbox cs_style_1 position-relative">
                            ...
                            <div class="cs_iconbox_text">
                                <h4 class="cs_iconbox_title cs_fs_21 cs_semibold">
                                    Free Shipping
                                </h4>
            ...
            <div class="cs_grid_list">
                <div class="cs_category cs_style_1">
                    <a href="shop.html" class="cs_category_thumb position-relative">
                        <img src="admin/assets/img/men.jpg" alt="Category Image" class="w-100" />
                ...
                <div class="cs_category cs_style_1">
                    <a href="shop.html" class="cs_category_thumb position-relative">
                        <img src="admin/assets/img/women.jpg" alt="Category Image" class="w-100" />
                        <span class="cs_category_btn">
                            <span>Women</span>
                            <span><i class="fa-solid fa-arrow-right"></i></span>
                        </span>
                ...
                <div class="cs_category cs_style_1">
                    <a href="shop.html" class="cs_category_thumb position-relative">
                        <img src="admin/assets/img/children.jpg" alt="Category Image" class="w-100" />
                        <span class="cs_category_btn">
                            <span>Children</span>
                            <span><i class="fa-solid fa-arrow-right"></i></span>
                        </span>
        ...
        <section>
            ...
            <div class="container">
                <h2 class="cs_section_title cs_fs_50 cs_bold mb-0 text-center">
                    Featured Items
                </h2>
                <div class="cs_height_63 cs_height_lg_35"></div>
                <ul class="cs_tab_links cs_style_1 cs_mp0">
                    <li class="active">
                        <a href="#tab_tshirt" class="cs_fs_16 cs_medium">T-shirt</a>
                    </li>
                    <li><a href="#tab_jeans" class="cs_fs_16 cs_medium">Jeans</a></li>
                    <li>
                        <a href="#tab_cshirt" class="cs_fs_16 cs_medium">Casual Shirt</a>
                    </li>
                    <li>
                        <a href="#tab_leggings" class="cs_fs_16 cs_medium">Leggings</a>
                    </li>
                    <li><a href="#tab_skirts" class="cs_fs_16 cs_medium">Skirts</a></li>
                    <li><a href="#tab_shoes" class="cs_fs_16 cs_medium">Shoes</a></li>
                    <li>
                        <a href="#tab_accessories" class="cs_fs_16 cs_medium">Accessories</a>
                    </li>
                </ul>
            </div>
            <div class="container-fluid">
                            ...
                            <div class="cs_slider_container" data-autoplay="0" data-loop="1" data-speed="600" data-center="0" data-slides-per-view="responsive" data-xs-slides="1" data-sm-slides="2" data-md-slides="2" data-lg-slides="3" data-add-slides="4">
                                <div class="cs_slider_wrapper">
                                    <div class="slick_slide_in">
                                        <div class="cs_product cs_style_1">
                                            <div class="cs_product_thumb position-relative">
                                                <img src="admin/assets/img/product1.png" alt="Product Image" />
                                    ...
                                    <div class="slick_slide_in">
                                        <div class="cs_product cs_style_1">
                                            <div class="cs_product_thumb position-relative">
                                                <img src="admin/assets/img/product2.png" alt="Product Image" />
                                                <div class="cs_discount_badge cs_white_bg cs_fs_14 cs_primary_color position-absolute">
                                                    -8%
                                                </div>
                                                <div class="cs_cart_badge position-absolute">
                                    ...
                                    <div class="slick_slide_in">
                                        <div class="cs_product cs_style_1">
                                            <div class="cs_product_thumb position-relative">
                                                <img src="admin/assets/img/product3.png" alt="Product Image" />
                                                <div class="cs_discount_badge cs_white_bg cs_fs_14 cs_primary_color position-absolute">
                                                    -12%
                                                </div>
                                                <div class="cs_cart_badge position-absolute">
                                    ...
                                    <div class="slick_slide_in">
                                        <div class="cs_product cs_style_1">
                                            <div class="cs_product_thumb position-relative">
                                                <img src="admin/assets/img/product8.png" alt="Product Image" />
                                                <div class="cs_cart_badge position-absolute">
                                                    <a href="wishlist.html" class="cs_cart_icon cs_accent_bg cs_white_color">
                                                        <i class="fa-regular fa-heart"></i>
                                                    </a>
                                    ...
                                    <div class="slick_slide_in">
                                        <div class="cs_product cs_style_1">
                                            <div class="cs_product_thumb position-relative">
                                                <img src="admin/assets/img/product26.png" alt="Product Image" />
                                                <div class="cs_cart_badge position-absolute">
                                                    <a href="wishlist.html" class="cs_cart_icon cs_accent_bg cs_white_color">
                                                        <i class="fa-regular fa-heart"></i>
                                                    </a>
                            ...
                            <div class="cs_slider_container" data-autoplay="0" data-loop="1" data-speed="600" data-center="0" data-slides-per-view="responsive" data-xs-slides="1" data-sm-slides="2" data-md-slides="2" data-lg-slides="3" data-add-slides="4">
                                <div class="cs_slider_wrapper">
                                    ...
                                    <div class="slick_slide_in">
                                        <div class="cs_product cs_style_1">
                                            <div class="cs_product_thumb position-relative">
                                                <img src="admin/assets/img/product9.png" alt="Product Image" />
                                                <div class="cs_discount_badge cs_white_bg cs_fs_14 cs_primary_color position-absolute">
                                                    -8%
                                                </div>
                                                <div class="cs_cart_badge position-absolute">
                            ...
                            <div class="cs_slider_container" data-autoplay="0" data-loop="1" data-speed="600" data-center="0" data-slides-per-view="responsive" data-xs-slides="1" data-sm-slides="2" data-md-slides="2" data-lg-slides="3" data-add-slides="4">
                                <div class="cs_slider_wrapper">
                                    <div class="slick_slide_in">
                                        <div class="cs_product cs_style_1">
                                            <div class="cs_product_thumb position-relative">
                                                <img src="admin/assets/img/product27.png" alt="Product Image" />
                                                <div class="cs_cart_badge position-absolute">
                                                    <a href="wishlist.html" class="cs_cart_icon cs_accent_bg cs_white_color">
                                                        <i class="fa-regular fa-heart"></i>
                                                    </a>
                                    ...
                                    <div class="slick_slide_in">
                                        <div class="cs_product cs_style_1">
                                            <div class="cs_product_thumb position-relative">
                                                <img src="admin/assets/img/product16.png" alt="Product Image" />
                                                <div class="cs_discount_badge cs_white_bg cs_fs_14 cs_primary_color position-absolute">
                                                    -8%
                                                </div>
                                                <div class="cs_cart_badge position-absolute">
                                    ...
                                    <div class="slick_slide_in">
                                        <div class="cs_product cs_style_1">
                                            <div class="cs_product_thumb position-relative">
                                                <img src="admin/assets/img/product28.png" alt="Product Image" />
                                                <div class="cs_cart_badge position-absolute">
                                                    <a href="wishlist.html" class="cs_cart_icon cs_accent_bg cs_white_color">
                                                        <i class="fa-regular fa-heart"></i>
                                                    </a>
                                    ...
                                    <div class="slick_slide_in">
                                        <div class="cs_product cs_style_1">
                                            <div class="cs_product_thumb position-relative">
                                                <img src="admin/assets/img/product4.png" alt="Product Image" />
                                                <div class="cs_cart_badge position-absolute">
                                                    <a href="wishlist.html" class="cs_cart_icon cs_accent_bg cs_white_color">
                                                        <i class="fa-regular fa-heart"></i>
                                                    </a>
                            ...
                            <div class="cs_slider_container" data-autoplay="0" data-loop="1" data-speed="600" data-center="0" data-slides-per-view="responsive" data-xs-slides="1" data-sm-slides="2" data-md-slides="2" data-lg-slides="3" data-add-slides="4">
                                <div class="cs_slider_wrapper">
                                    <div class="slick_slide_in">
                                        <div class="cs_product cs_style_1">
                                            <div class="cs_product_thumb position-relative">
                                                <img src="admin/assets/img/product5.png" alt="Product Image" />
                                                <div class="cs_cart_badge position-absolute">
                                                    <a href="wishlist.html" class="cs_cart_icon cs_accent_bg cs_white_color">
                                                        <i class="fa-regular fa-heart"></i>
                                                    </a>
                                    ...
                                    <div class="slick_slide_in">
                                        <div class="cs_product cs_style_1">
                                            <div class="cs_product_thumb position-relative">
                                                <img src="admin/assets/img/product6.png" alt="Product Image" />
                                                <div class="cs_cart_badge position-absolute">
                                                    <a href="wishlist.html" class="cs_cart_icon cs_accent_bg cs_white_color">
                                                        <i class="fa-regular fa-heart"></i>
                                                    </a>
                                    ...
                                    <div class="slick_slide_in">
                                        <div class="cs_product cs_style_1">
                                            <div class="cs_product_thumb position-relative">
                                                <img src="admin/assets/img/product7.png" alt="Product Image" />
                                                <div class="cs_cart_badge position-absolute">
                                                    <a href="wishlist.html" class="cs_cart_icon cs_accent_bg cs_white_color">
                                                        <i class="fa-regular fa-heart"></i>
                                                    </a>
                            ...
                            <div class="cs_slider_container" data-autoplay="0" data-loop="1" data-speed="600" data-center="0" data-slides-per-view="responsive" data-xs-slides="1" data-sm-slides="2" data-md-slides="2" data-lg-slides="3" data-add-slides="4">
                                <div class="cs_slider_wrapper">
                                    <div class="slick_slide_in">
                                        <div class="cs_product cs_style_1">
                                            <div class="cs_product_thumb position-relative">
                                                <img src="admin/assets/img/product10.png" alt="Product Image" />
                                                <div class="cs_cart_badge position-absolute">
                                                    <a href="wishlist.html" class="cs_cart_icon cs_accent_bg cs_white_color">
                                                        <i class="fa-regular fa-heart"></i>
                                                    </a>
                                    ...
                                    <div class="slick_slide_in">
                                        <div class="cs_product cs_style_1">
                                            <div class="cs_product_thumb position-relative">
                                                <img src="admin/assets/img/product11.png" alt="Product Image" />
                                                <div class="cs_discount_badge cs_white_bg cs_fs_14 cs_primary_color position-absolute">
                                                    -12%
                                                </div>
                                                <div class="cs_cart_badge position-absolute">
                                            ...
                                            <div class="cs_product_info text-center">
                                                <h3 class="cs_product_title cs_fs_21 cs_medium">
                                                    <a href="product_details.html">Cotton black suit for men
                                                    </a>
                                                </h3>
                                                <p class="cs_product_price cs_fs_18 cs_accent_color mb-0 cs_medium">
                                                    $350.00
                    ...
                    <div class="row cs_gap_y_30 align-items-center">
                        <div class="col-lg-6">
                            <div class="cs_card_thumb">
                                <img src="admin/assets/img/card1.jpg" alt="Card Image" class="w-100" />
                            </div>
                        </div>
                        <div class="col-lg-6">
                            <div class="cs_card_info">
                                <h2 class="cs_card_title cs_fs_50 cs_bold">
                                    Explore our latest winter fashion collection
                                </h2>
                                <p class="cs_card_subtitle">
                                    We believe that winter fashion should be both functional and
                                    fabulous. <br />
                                    Our Winter Fashion Collection reflects our commitment to
                                    quality, comfort <br />
                                    and style. Embrace the season with confidence.
                                </p>
                                <a href="shop.html" class="cs_btn cs_style_1 cs_fs_16 cs_medium">Shop Now</a>
                            </div>
                        </div>
                    ...
                    <div class="cs_slider_wrapper">
                        <div class="slick_slide_in">
                            <div class="cs_partner_logo">
                                <img src="admin/assets/img/brand_1.svg" alt="Partner Logo" />
                            </div>
                        </div>
                        <div class="slick_slide_in">
                            <div class="cs_partner_logo">
                                <img src="admin/assets/img/brand_2.svg" alt="Partner Logo" />
                            </div>
                        </div>
                        <div class="slick_slide_in">
                            <div class="cs_partner_logo">
                                <img src="admin/assets/img/brand_3.svg" alt="Partner Logo" />
                            </div>
                        </div>
                        <div class="slick_slide_in">
                            <div class="cs_partner_logo">
                                <img src="admin/assets/img/brand_4.svg" alt="Partner Logo" />
                            </div>
                        </div>
                        <div class="slick_slide_in">
                            <div class="cs_partner_logo">
                                <img src="admin/assets/img/brand_5.svg" alt="Partner Logo" />
                            </div>
                        </div>
                        <div class="slick_slide_in">
                            <div class="cs_partner_logo">
                        ...
                        <div class="cs_slider_wrapper">
                            <div class="slick_slide_in">
                                <div class="cs_testimonial cs_style_1 text-center">
                                    <blockquote class="cs_testimonial_text cs_fs_21 cs_semibold">
                                        Shopping at Sattiyas has been an absolute delight! I've had
                                        the pleasure of being a <br />
                                        customer for the past year, and I can confidently say that
                                        this is my go-to online shopping <br />
                                    ...
                                    <div class="cs_testimonial_user">
                                        ...
                                        <h4 class="cs_avatar_title cs_fs_21 cs_semibold mb-0">
                                            Bonal Ahmad
                                        </h4>
                            ...
                            <div class="slick_slide_in">
                                <div class="cs_testimonial cs_style_1 text-center">
                                    ...
                                    <div class="cs_testimonial_user">
                                        <div class="cs_avatar_thumb">
                                            <img src="admin/assets/img/user2.png" alt="Avatar" />
                                        </div>
                                        <h4 class="cs_avatar_title cs_fs_21 cs_semibold mb-0">
                                            Jhon Doe
                                        </h4>
                            ...
                            <div class="slick_slide_in">
                                <div class="cs_testimonial cs_style_1 text-center">
                                    ...
                                    <div class="cs_testimonial_user">
                                        <div class="cs_avatar_thumb">
                                            <img src="admin/assets/img/user3.png" alt="Avatar" />
                                        </div>
                                        <h4 class="cs_avatar_title cs_fs_21 cs_semibold mb-0">
                                            Kalio Hokeo
                                        </h4>
            ...
            <div class="cs_card cs_style_2">
                <div class="container">
                    <div class="row cs_gap_y_30 align-items-center">
                        <div class="col-lg-6">
                            <div class="cs_card_info">
                                ...
                                <p class="cs_card_subtitle">
                                    We believe that winter fashion should be both functional and
                                    fabulous. Our <br />
                                    Winter Fashion Collection reflects our commitment to quality,
                                    comfort, and <br />
                        ...
                        <div class="col-lg-6">
                            <div class="cs_card_thumb cs_bg_filed" data-src="admin/assets/img/card2.jpg"></div>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="cs_slider_container" data-autoplay="0" data-loop="1" data-speed="600" data-center="0" data-slides-per-view="responsive" data-xs-slides="1" data-sm-slides="2" data-md-slides="2" data-lg-slides="3" data-add-slides="4">
                    <div class="cs_slider_wrapper">
                        <div class="slick_slide_in">
                            <div class="cs_product cs_style_1">
                                <div class="cs_product_thumb position-relative">
                                    <img src="admin/assets/img/product12.png" alt="Product Image" />
                                    <div class="cs_cart_badge position-absolute">
                                        <a href="wishlist.html" class="cs_cart_icon cs_accent_bg cs_white_color">
                                            <i class="fa-regular fa-heart"></i>
                                        </a>
                        ...
                        <div class="slick_slide_in">
                            <div class="cs_product cs_style_1">
                                <div class="cs_product_thumb position-relative">
                                    <img src="admin/assets/img/product13.png" alt="Product Image" />
                                    <div class="cs_cart_badge position-absolute">
                                        <a href="wishlist.html" class="cs_cart_icon cs_accent_bg cs_white_color">
                                            <i class="fa-regular fa-heart"></i>
                                        </a>
                        ...
                        <div class="slick_slide_in">
                            <div class="cs_product cs_style_1">
                                <div class="cs_product_thumb position-relative">
                                    <img src="admin/assets/img/product14.png" alt="Product Image" />
                                    <div class="cs_cart_badge position-absolute">
                                        <a href="wishlist.html" class="cs_cart_icon cs_accent_bg cs_white_color">
                                            <i class="fa-regular fa-heart"></i>
                                        </a>
                        ...
                        <div class="slick_slide_in">
                            <div class="cs_product cs_style_1">
                                <div class="cs_product_thumb position-relative">
                                    <img src="admin/assets/img/product15.png" alt="Product Image" />
                                    <div class="cs_cart_badge position-absolute">
                                        <a href="wishlist.html" class="cs_cart_icon cs_accent_bg cs_white_color">
                                            <i class="fa-regular fa-heart"></i>
                                        </a>
            ...
            <div class="container">
                <div class="cs_newsletter cs_style_1 cs_radius_15 cs_bg_filed">
                    ...
                    <div class="cs_newsletter_text ms-auto">
                        ...
                        <p class="cs_newsletter_subtitle cs_white_color">
                            Join the style revolution and subscribe to our fashion shop
                        </p>
                        <form class="cs_newsletter_form">
                            <input type="text" placeholder="Enter your email address ..." class="cs_form_field" />
        ...
        <div class="cs_instagram">
            <a href="https://www.instagram.com/" target="_blank" class="position-relative cs_instagram_item">
                <div class="cs_instagram_thumb position-relative">
                    <img src="admin/assets/img/instagram_1.jpg" alt="Instagram" />
                </div>
            ...
            <a href="https://www.instagram.com/" target="_blank" class="position-relative cs_instagram_item">
                <div class="cs_instagram_thumb position-relative">
                    <img src="admin/assets/img/instagram_2.jpg" alt="Instagram" />
                </div>
                <div class="cs_instagram_overlay position-absolute">
                    <i class="fa-brands fa-instagram"></i>
                </div>
            ...
            <a href="https://www.instagram.com/" target="_blank" class="position-relative cs_instagram_item">
                <div class="cs_instagram_thumb position-relative">
                    <img src="admin/assets/img/instagram_3.jpg" alt="Instagram" />
                </div>
                <div class="cs_instagram_overlay position-absolute">
                    <i class="fa-brands fa-instagram"></i>
                </div>
            ...
            <a href="https://www.instagram.com/" target="_blank" class="position-relative cs_instagram_item">
                <div class="cs_instagram_thumb position-relative">
                    <img src="admin/assets/img/instagram_4.jpg" alt="Instagram" />
                </div>
                <div class="cs_instagram_overlay position-absolute">
                    <i class="fa-brands fa-instagram"></i>
                </div>
            ...
            <a href="https://www.instagram.com/" target="_blank" class="position-relative cs_instagram_item">
                <div class="cs_instagram_thumb position-relative">
                    <img src="admin/assets/img/instagram_5.jpg" alt="Instagram" />
                </div>
                <div class="cs_instagram_overlay position-absolute">
                    <i class="fa-brands fa-instagram"></i>
                </div>
            ...
            <a href="https://www.instagram.com/" target="_blank" class="position-relative cs_instagram_item">
                <div class="cs_instagram_thumb position-relative">
                    <img src="admin/assets/img/instagram_6.jpg" alt="Instagram" />
                </div>
                <div class="cs_instagram_overlay position-absolute">
                    <i class="fa-brands fa-instagram"></i>
                </div>
